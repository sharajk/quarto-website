...
### A Network analysis of Intermedia Agenda-setting in the News discourse about the Mpox epidemic
...
<i>
Growing up, I'd often have to convince my parents to take me out for lunch. It'd start with me yelling that I want to have restaurant soup and kebabs. 1 out of 5 times, my mom would back me up. When she did, my dad (the one who'd pay for the lunch) was more likely to agree to take us out. This decision was a group one: I'd initiate the idea, my mom would amplify my idea, and my dad my finalize the decision. So even though the decision was a consensus one, we all played different roles in the process. What if animals did something similar? What if there are special roles that different members of a group assume when they decide to forage?
</i>
